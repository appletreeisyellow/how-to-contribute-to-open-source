...
## 一般开源贡献
- [The Definitive Guide to Contributing to Open Source](https://www.freecodecamp.org/news/the-definitive-guide-to-contributing-to-open-source-900d5f9f2282/) 来自 [@DoomHammerNG](https://twitter.com/DoomHammerNG)
...
- [Issuehub.pro](http://issuehub.pro/) - 一个通过标签和语言来搜索GitHub issue的工具。
...
## 使用版本控制
- [Think Like (a) Git](http://think-like-a-git.net/) - 为“高阶初学者”提供的Git介绍，但是仍然在努力为了给你一个简单的策略来安全地体验Git。
